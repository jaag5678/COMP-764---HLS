...
\begin{document}
    ...
    \begin{frame}{What sort of bugs are addressed?}
        ...
        \begin{itemize}
            \item Bugs are often in the several optimizations done by HLS tools.
            \item These optimizations are done to meet several needs such as timing, area, power, etc.
    ...
    \begin{frame}{Code size ?? Bug finding}
        ...
        \begin{figure}
            \includegraphics{CodeSize_vs_Bugs.PNG}
        \end{figure}
    ...
    \note{
        \begin{itemize}
            \item The colums from left to right represent how many bugs found for each configuration of verismith.
